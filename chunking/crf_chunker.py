...
def predict_with_crf(doc):
	...
	file = open('chunking/state_dicts/model/sklearn_crf_model_v2_pos_mapped_2.pkl', 'rb')
	...
	process = subprocess.Popen('/media/data_dump/Ritwik/crf/CRF++-0.58/crf_test -m /media/data_dump/Ritwik/crf/CRF++-0.58/example/chunking/crf_model tempfile.txt > tempfile2.txt',shell=True)
	process.wait()
	# time.sleep(5)
